    ...
    return (
        <div className="px-4 md:px-0">
            <ImageCursorTrail
                ...
                className="max-w-4xl rounded-3xl mx-auto"
            >
                <article className="relative z-50 flex flex-col items-center justify-center px-4">
                <h1 className="max-w-2xl text-center text-2xl md:text-4xl lg:text-5xl font-semibold tracking-tight">
...
export default ImageTrailParent;
