...
import CardSwiperParent from '@/components/HomeCards/CardSwiperParent';
  ...
  return (
        ...
        <br /><br />
          ...
          <div className="px-4 md:px-5 py-5 ">
            <h4 className='text-center md:text-left md:ml-3 text-lg md:text-xl font-[skip]'>Built by <span className='font-bold text-color-1 border-b-2 border-blue-800 '>Arpit.</span> The source code is on <span className='font-bold border-b-2 border-blue-800 '><a href="https://github.com/arpitsainix">GitHub</a></span>. </h4>
          </div>
        </div>
  )
}
